...
; R5 - current sum
            ...
            .ORIG x3000
            LD    R0, ZERO            ; initialize R0 to zero
            LD    R1, ZERO            ; initialize R1 to zero
            LD    R2, ZERO            ; initialize R2 to zero
            LD    R3, ZERO            ; initialize R3 to zero
            LD    R4, ZERO            ; initialize R4 to zero
            LD    R5, ZERO            ; initialize R5 to zero
            LDI   R1, INPUT           ; Load INPUT into R2 using label
            LD    R2, NEG_ONE         ; Load -1 into R2 from below
